    ...
    if (category === 'thunderstorm') {
        ...
        if (isNight) {
            svgContent = `
                ${defs}
                <!-- Moon -->
                <path d="M36 14 A 12 12 0 0 1 48 26 A 12 12 0 0 1 36 38 A 15 15 0 0 1 36 14 Z" fill="url(#moon-grad-${uid})" />
                <!-- Cloud -->
        ...
        if (isNight) {
            svgContent = `
                ${defs}
                <!-- Moon -->
                <path d="M30 14 A 18 18 0 0 1 48 32 A 18 18 0 0 1 30 50 A 22 22 0 0 1 30 14 Z" fill="url(#moon-grad-${uid})" />
            `;
        } else {
            svgContent = `
                ${defs}
...
function updateVelocityLayer() {
    ...
    if (!selectedRadarId || selectedRadarId === 'composite') {
        ...
        radarVelocity = L.tileLayer.wms(specificWmsUrl, {
            ...
            transparent: true, opacity: 0.8, maxNativeZoom: 15, attribution: `Radar: ${station.id}`
        });
    }
}
