...
- [x] **3. Update Storm Attributes:**
    - [x] Changed labels for Rotation, Hail, and Core to use icons: 🔄, 🧊, ⛈️.
    - [x] Transitioned map markers to **Icon-Only** visuals for precision, removing text labels that obscured radar scans.
    - [x] Renamed "Core" to "Storm Core" in the control panel for clarity.
...
- [x] **6. Improve Temperature Grid Data:**
    - [x] Switched backend source to NDFD 00hr layers for the most accurate current condition analysis available.
...
- [2026-05-10] Streamlined Storm Signals to icon-only map markers for better radar visibility.
